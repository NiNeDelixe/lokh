...
// configuration step. It creates a namespace called `lokh`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", lokh::cmake::project_name, lokh::cmake::project_version) };
