...
function(lokh_setup_bloaty TARGET_NAME)
  ...
  if(BLOATY)
    ...
    message(${lokh_WARNING_TYPE} "Bloaty McBloatface requested but executable not found. Install with 'apt install bloaty' or from https://github.com/google/bloaty")
  endif()
endfunction()

# Function to add bloaty analysis to all executable targets
function(lokh_enable_bloaty)
  find_program(BLOATY bloaty)
  if(BLOATY)
